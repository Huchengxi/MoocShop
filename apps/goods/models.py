...
class GoodsCategory(models.Model):
    ...
    name = models.CharField(max_length=30, default='', verbose_name='类别名',
                            help_text='类别名')
    code = models.CharField(max_length=30, default='', verbose_name='类别名code',
                            help_text='类别名code')
    desc = models.TextField(default='', verbose_name='商品描述', help_text='类型描述')
    category_type = models.IntegerField(choices=Category_TYPE,
                                        verbose_name='类目级别', help_text='类目级别')
    # 外键自指， related_name 是反向引用时防止重名
    parent_type = models.ForeignKey('self', null=True, blank=True,
...
class GoodsCategoryBrand(models.Model):
    ...
    name = models.CharField(max_length=30, default='', verbose_name='品牌名',
                            help_text='平牌名')
    desc = models.TextField(default='', max_length=200, verbose_name='平牌描述',
                            help_text='品牌描述')
...
class GoodsImage(models.Model):
    ...
    image = models.ImageField(upload_to='', verbose_name='图片', null='', blank='')
    add_time = models.DateTimeField(default=datetime.datetime.now,
                                    verbose_name='添加时间')
